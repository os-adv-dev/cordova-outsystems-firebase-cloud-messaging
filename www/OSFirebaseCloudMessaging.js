...
exports.sendLocalNotification = function (badge, title, body, channelName, channelDescription, sound, success, error) {
    exec(success, error, 'OSFirebaseCloudMessaging', 'sendLocalNotification', [badge, title, body, channelName, channelDescription, sound]);
};
