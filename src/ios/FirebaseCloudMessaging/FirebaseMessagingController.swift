...
open class FirebaseMessagingController: NSObject {
    ...
    public func sendLocalNotification(title: String, body: String, badge: Int, sound: String?) async {
        let result = await notificationManager.sendLocalNotification(title: title, body: body, badge: badge, sound: sound)
